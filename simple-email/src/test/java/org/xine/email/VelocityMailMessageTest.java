    ...
    public void testVelocityTextMailMessage() throws MessagingException, IOException {
        ...
        try {
            ...
            e = new MailMessageImpl(mailConfig)
                    ...
                    .bodyText(
                            new VelocityTemplate(Resources.newInputStreamSupplier(
                                    Resources.getResource("template.text.velocity")).getInput()))
                    .put("version", version).put("person", person).importance(MessagePriority.HIGH)
                    .send();
        } finally {
            stop(wiser);
        }
    ...
    public void testVelocityHTMLMailMessage() throws MessagingException, IOException {
        ...
        try {
            ...
            emailMessage = new MailMessageImpl(mailConfig)
                    ...
                    .bodyHtml(
                            new VelocityTemplate(Resources.newInputStreamSupplier(
                                    Resources.getResource("template.html.velocity")).getInput()))
                    .put("version", version)
                    .put("person", person)
        ...
        try {
            ...
            new MailMessageImpl(mailConfig)
                    ...
                    .bodyText(
                            new VelocityTemplate(Resources.newInputStreamSupplier(
                                    Resources.getResource("template.text.velocity")).getInput()))
                    .put("version", version).importance(MessagePriority.HIGH).send();
        } finally {
            stop(wiser);
        }
    }
