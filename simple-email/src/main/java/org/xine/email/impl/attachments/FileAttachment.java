...
public class FileAttachment extends BaseAttachment {
    ...
    public FileAttachment(final ContentDisposition contentDisposition, final Path path) {
        super();
        try {
    ...
    public FileAttachment(final ContentDisposition contentDisposition, final File file) {
