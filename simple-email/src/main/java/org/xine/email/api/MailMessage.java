...
public interface MailMessage {
     ...
     * @param address
     *            Address of the recipient eq "john.doe@example.com" or
     ...
     * @param textBody
     *            Summary of the invite to be displayed in the alternate text body of the email
     *            messages.
     * @param ICalMethod
     *            iCalMethod
     * @param bytes
    ...
    /**
     * Sets the body of the message to a HTML body with a plain text alternative output of the
     * given templates
     * @param htmlBody
